...
import com.ichat.netty.ChatMsg;
import com.ichat.netty.DataContent;
import com.ichat.netty.UserChannelRelationship;
...
public class UserServiceImpl implements UserService {
    ...
    public String saveMsg(ChatMsg chatMsg) {
        com.ichat.pojo.ChatMsg msgDB = new com.ichat.pojo.ChatMsg();
    ...
    @Transactional(propagation = Propagation.SUPPORTS)
    @Override
    public List<com.ichat.pojo.ChatMsg> getUnReadMsgList(String acceptUserId) {
        Example chatExample = new Example(com.ichat.pojo.ChatMsg.class);
        ...
        List<com.ichat.pojo.ChatMsg> result = chatMsgMapper.selectByExample(chatExample);
